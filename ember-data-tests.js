...
QUnit.test('ember-data/lib/system/snapshot.js should pass jshint', function(assert) { 
  assert.ok(false, 'ember-data/lib/system/snapshot.js should pass jshint.\nember-data/lib/system/snapshot.js: line 348, col 8, Duplicate exported binding: \'default\'.\n\n1 error'); 
});
...
QUnit.test('ember-data/tests/unit/store/create-record-test.js should pass jshint', function(assert) { 
  assert.ok(false, 'ember-data/tests/unit/store/create-record-test.js should pass jshint.\nember-data/tests/unit/store/create-record-test.js: line 1, col 31, Redefinition of \'Storage\'.\n\n1 error'); 
});
